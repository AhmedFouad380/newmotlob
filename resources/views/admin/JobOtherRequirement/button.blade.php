        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" enctype="multipart/form-data" method="post" action="{{url('store-JobOtherRequirement')}}">
                    @csrf
                    <!--begin::Scroll-->
        ...
        if (dataList.length > 0) {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{url("delete-JobOtherRequirement")}}',
                        type: "get",
