                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="company_name"
                                       ...
                                       placeholder="الاسم" value="{{$employee->company_name}}" required/>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="first_name"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="الاسم" value="{{$employee->first_name}}" required/>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="last_name"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="الاسم" value="{{$employee->last_name}}" required/>
...
{{--                            </div>--}}
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="tax_card_number"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="رقم الجوال" value="{{$employee->tax_card_number }}" />
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
