                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                    ...
                                    <div class="col-lg-6 col-xl-6">
                                        <div class="card">
                                            <div class="card-block">
                                                ...
                                                <div class="controls">
                                                    <input type="file" id="input-file-now" class="dropify"  name="image" data-default-file=""   data-validation-required-message="{{trans('word.This field is required')}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="type" class="form-control">
                                    <option value="header">في شريط العنواين في الاعلى </option>
                                    <option value="footer">في شريط العنواين في الاسفل </option>
                                </select>
                                <!--end::Input-->
                            </div>
