...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ url('/Pages') }}" class="text-gray-600 text-hover-primary">قائمة الصفحة التعريفية</a>
        </li>
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="type" class="form-control">
                                    <option @if($employee->type == 'header') selected  @endif  value="header">في شريط العنواين في الاعلى </option>
                                    <option @if($employee->type == 'footer') selected  @endif  value="footer">في شريط العنواين في الاسفل </option>
                                </select>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
