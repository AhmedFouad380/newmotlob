...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-500">المتقدمين للوظيفة : {{$data->title}}</li>
        <li class="breadcrumb-item text-gray-500">شركة  : {{$data->Company->company_name}}</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('script')
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-JobRequests/'.$id)}}",
