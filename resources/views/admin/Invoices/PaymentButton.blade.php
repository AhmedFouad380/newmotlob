        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" enctype="multipart/form-data" method="post" action="{{url('store-InvoicePayment')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="number" name="price" value="{{$Invoice->find($id)->total_price - $InvoicePayments->where('invoice_id',$id)->sum('price')}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select class="form-control" name="type" id="type">
                                    <option value="payment_method">  البوابة الالكترونية </option>
                                    <option value="cash">  كاش </option>
                                </select>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7" id="payment_invoice_id">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2"> رقم الفاتورة في بوابة الدفع</label>
                                <!--end::Label-->
                                <!--begin::Input-->
...
<script type="text/javascript">
    $('#type').on('click , change',function () {
        if($(this).val() == 'cash'){
            document.getElementById("payment_invoice_id").style.display = "none";

        }else{
            document.getElementById("payment_invoice_id").style.display = "block";
