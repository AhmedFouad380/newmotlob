...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500">دفعات الفاتورة رقم {{$data->num}} </li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px"> رقم  بوابة الدفع  </th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('InvoicePayment.datatable.data') }}',
                    data: {
                        id:{{$id}},
                    }
                },
                columns: [
                    ...
                    {data: 'payment_invoice_id', name: 'payment_invoice_id', "searchable": true, "orderable": true},
                    {data: 'date', name: 'date', "searchable": false, },
                    {data: 'type', name: 'type', "searchable": false},
                    {data: 'price', name: 'price', "searchable": false},
                    {data: 'description', name: 'description', "searchable": false},
                    {data: 'admin_id', name: 'admin_id', "searchable": false},

                ]
            });
            $.ajax({
                url: "{{ URL::to('/add-button-InvoicePayment',$id)}}",
