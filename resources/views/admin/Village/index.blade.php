                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">المركز</th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('Village.datatable.data') }}',
                    data: {
                    state_id:{{$id}}
                    }
                },
                columns: [
                    ...
                    {data: 'state_id', name: 'state_id', "searchable": true, "orderable": true},
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-Village/'.$id)}}",
