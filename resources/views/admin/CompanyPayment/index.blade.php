...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500">عمليات الدفع </li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px"> اسم الباقة   </th>
                            <th class="min-w-125px"> سعر الباقه   </th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('CompanyPayment.datatable.data') }}',
                    data: {
                ...
                columns: [
                    ...
                    {data: 'company_id', name: 'user_id', "searchable": true, "orderable": true},
                    {data: 'user_phone', name: 'user_phone', "searchable": true, "orderable": true},
                    {data: 'package_id', name: 'package_id', "searchable": true, "orderable": true},
                    {data: 'package_price', name: 'package_price', "searchable": true, "orderable": true},
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-CompanyPayment')}}",
