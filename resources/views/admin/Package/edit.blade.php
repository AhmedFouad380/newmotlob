        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" enctype="multipart/form-data" action="{{url('update-Package')}}" class="form"
                          method="post">
                    @csrf
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select class="form-control" name="type">
                                    <option @if($employee->type == 'time') selected @endif value="time">  بالوقت </option>
                                    <option @if($employee->type == 'count') selected @endif value="count">  العدد </option>
                                </select>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7" >
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">المدة ( بالشهر او المرات ) </label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="count" value="{{$employee->count}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
