...
class HoldReasonController extends Controller
{
    public function index(){
        ...
        return view('admin.HoldReason.index');
    }
    public function datatable(Request $request)
    {
        $data = HoldReason::orderBy('id', 'desc');
    ...
    public function update(Request $request){
        ...
        $data =  HoldReason::find($request->id);
        $data->reason=$request->reason;
        $data->is_active=$request->is_active;
    ...
    {
        $employee = HoldReason::findOrFail($id);
        return view('admin.HoldReason.edit', compact('employee'));
    }

    public function destroy(Request $request)
    {
        try {
            HoldReason::whereIn('id', $request->id)->delete();
        } catch (\Exception $e) {
