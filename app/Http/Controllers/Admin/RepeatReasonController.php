...
use App\Models\RepeatReason;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Yajra\DataTables\Facades\DataTables;

class RepeatReasonController extends Controller
{
    public function index(){

        return view('admin.RepeatReason.index');
    }
    public function datatable(Request $request)
    {
        $data = RepeatReason::orderBy('id', 'desc');
    ...
    public function update(Request $request){
        ...
        $data =  RepeatReason::find($request->id);
        $data->reason=$request->reason;
        $data->is_active=$request->is_active;
    ...
    {
        $employee = RepeatReason::findOrFail($id);
        return view('admin.RepeatReason.edit', compact('employee'));
    }

    public function destroy(Request $request)
    {
        try {
            RepeatReason::whereIn('id', $request->id)->delete();
        } catch (\Exception $e) {
