...
class JobTypeController extends Controller
{
    ...
    public function datatable(Request $request)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('actions', function ($row) {
                $actions = ' <a href="' . url("JobType-edit/" . $row->id) . '" class="btn btn-active-light-info"><i class="bi bi-pencil-fill"></i> تعديل </a>';
                return $actions;
    ...
    {
        $employee = JobType::findOrFail($id);
        return view('admin.JobType.edit', compact('employee'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('JobType')->with('message', 'تم التعديل بنجاح ');
    }
