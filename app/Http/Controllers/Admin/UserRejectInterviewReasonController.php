...
use App\Models\UserRejectInterviewReason;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Yajra\DataTables\Facades\DataTables;

class UserRejectInterviewReasonController extends Controller
{
    public function index(){

        return view('admin.UserRejectInterviewReason.index');
    }
    public function datatable(Request $request)
    {
        $data = UserRejectInterviewReason::orderBy('id', 'desc');
    ...
    public function store(Request $request){
        ...
        $data = new UserRejectInterviewReason();
    ...
    public function update(Request $request){
        ...
        $data =  UserRejectInterviewReason::find($request->id);
        $data->reason=$request->reason;
        $data->is_active=$request->is_active;
    ...
    {
        $employee = UserRejectInterviewReason::findOrFail($id);
        return view('admin.UserRejectInterviewReason.edit', compact('employee'));
    }

    public function destroy(Request $request)
    {
        try {
            UserRejectInterviewReason::whereIn('id', $request->id)->delete();
        } catch (\Exception $e) {
